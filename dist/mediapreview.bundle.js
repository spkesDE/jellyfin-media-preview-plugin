...
`;function Yt(){if(document.getElementById(Ve))return;let e=document.createElement("style");e.id=Ve,e.textContent=qt,document.head.appendChild(e)}function H(e,t){let r=N(e);if(!r)return null;let n=r;if(window.getComputedStyle(n).position==="static"&&(n.style.position="relative"),window.getComputedStyle(n).overflow!=="hidden"&&(n.style.overflow="hidden"),t.rootHost=n,!t.previewBackdrop){let o=document.createElement("div");o.className="jmp-preview-backdrop",o.setAttribute("aria-hidden","true"),n.appendChild(o),t.previewBackdrop=o}if(!t.previewFrame){let o=document.createElement("div");o.className="jmp-preview-layer",o.setAttribute("aria-hidden","true"),o.style.display="none",n.appendChild(o),t.previewFrame=o}if(!t.hoverCountdown){let o=document.createElement("div");o.className="jmp-hover-countdown",o.setAttribute("aria-hidden","true"),o.style.display="none",o.style.setProperty("--progress","1");let i=document.createElement("span");i.className="jmp-hover-countdown-label",i.textContent="1",o.appendChild(i),n.appendChild(o),t.hoverCountdown=o,t.hoverCountdownLabel=i}if(!t.unavailableMessage){let o=document.createElement("div");o.className="jmp-unavailable-message",o.setAttribute("aria-hidden","true"),o.style.display="none",n.appendChild(o),t.unavailableMessage=o}if(!t.trailerLayer){let o=document.createElement("div");o.className="jmp-trailer-layer",o.setAttribute("aria-hidden","true"),n.appendChild(o),t.trailerLayer=o}if(!t.trailerActions){let o=document.createElement("div");o.className="jmp-trailer-actions",o.setAttribute("aria-hidden","true"),o.style.display="none";let i=document.createElement("button");i.className="jmp-trailer-expand",i.type="button",i.title="Expand trailer",i.setAttribute("aria-label","Expand trailer"),i.innerHTML='<span class="material-icons" aria-hidden="true">open_in_full</span>',i.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),_t(e)}),i.addEventListener("pointerdown",l=>{l.stopPropagation()}),o.appendChild(i),n.appendChild(o),t.trailerActions=o,t.trailerExpandButton=i}if(zt(t),Gt(t),!t.progress){let o=document.createElement("div");o.className="jmp-progress",o.setAttribute("aria-hidden","true"),o.style.display="none";let i=document.createElement("div");i.className="jmp-progress-bar",o.appendChild(i),n.appendChild(o),t.progress=o,t.progressBar=i}return t}function q(e){if(!e?.previewBackdrop)return;let t=e.previewBackdrop.style;e.previewBackdrop.style.display="none",e.previewBackdrop.style.background="transparent",t.backdropFilter="none",t.webkitBackdropFilter="none"}function Gt(e){e?.hoverCountdown&&(e.hoverCountdown.classList.remove("pos-top-left","pos-top-right","pos-bottom-left","pos-bottom-right"),e.hoverCountdown.classList.add(`pos-${a.hoverCountdownPosition}`))}function _e(e,t,r){if(!e?.hoverCountdown||!e.hoverCountdownLabel)return;Gt(e);let n=Math.max(1,r),o=Math.max(0,t),i=Math.max(0,Math.min(1,o/n)),l=Math.max(0,Math.ceil(o/1e3));e.hoverCountdown.style.display="block",e.hoverCountdown.style.setProperty("--progress",i.toFixed(4)),e.hoverCountdownLabel.textContent=String(l)}function k(e){e?.hoverCountdownFrame&&(window.cancelAnimationFrame(e.hoverCountdownFrame),e.hoverCountdownFrame=null),!(!e?.hoverCountdown||!e.hoverCountdownLabel)&&(e.hoverCountdownStartedAt=null,e.hoverCountdownDurationMs=0,e.hoverCountdown.style.display="none",e.hoverCountdown.style.setProperty("--progress","1"),e.hoverCountdownLabel.textContent="1")}function Kt(e,t){e?.unavailableMessage&&(e.unavailableMessage.textContent=t,e.unavailableMessage.style.display="block")}function ke(e){e?.unavailableMessage&&(e.unavailableMessage.style.display="none",e.unavailableMessage.textContent="")}function oe(e,t){e?.trailerActions&&(zt(e),e.trailerActions.style.display=t&&a.trailerExpandButtonEnabled?"block":"none")}function zt(e){e?.trailerActions&&(e.trailerActions.classList.remove("pos-top-left","pos-top-right","pos-bottom-left","pos-bottom-right"),e.trailerActions.classList.add(`pos-${a.trailerExpandButtonPosition}`))}function Lt(e){if(!e?.previewBackdrop)return;let t=St(),r=!(t.background==="transparent"&&t.backdropFilter==="none"),n=e.previewBackdrop.style;n.display=r?"block":"none",n.background=t.background,n.backdropFilter=t.backdropFilter,n.webkitBackdropFilter=t.webkitBackdropFilter}function at(e,t){e?.trailerLayer&&(e.trailerLayer.style.display=t?"block":"none",e.trailerLayer.style.visibility=t?"visible":"hidden",e.trailerLayer.style.opacity=t?"1":"0")}function lt(e){e?.previewFrame&&(e.previewFrame.style.display="none",e.previewFrame.style.backgroundImage="")}function Ht(e,t){!e?.progress||!e.progressBar||(e.progress.style.display="",e.progressBar.style.width=`${Math.round((t||0)*100)}%`)}function ie(e){e?.progress&&(e.progress.style.display="none")}function Nr(e){e?.queuedMoveTimer&&(window.clearTimeout(e.queuedMoveTimer),e.queuedMoveTimer=null),e?.queuedMoveFrame&&(window.cancelAnimationFrame(e.queuedMoveFrame),e.queuedMoveFrame=null)}function ue(e){e?.leaveHoldTimer&&(window.clearTimeout(e.leaveHoldTimer),e.leaveHoldTimer=null)}function P(e){let t=b(e);t&&(u.expandedTrailerSession&&u.expandedTrailerSession.card===e||(t.hoverTimer&&(window.clearTimeout(t.hoverTimer),t.hoverTimer=null),ue(t),Nr(t),B(t),t.previewActive=!1,t.lastPreviewKey=null,t.activePreviewSource=null,t.queuedPercent=null,t.autoScrubPercent=null,t.currentTrickplayInfo=null,t.lastRequestedTrickplayFrameIndex=null,t.lastRenderedTrickplayFrameIndex=null,t.lastTrickplayRenderAt=0,k(t),ke(t),a.restoreOnLeave&&lt(t),xe(t),q(t),ie(t)))}function Jt(){document.querySelectorAll(`[${te}="true"]`).forEach(e=>{e.remove()}),document.querySelectorAll(`[${V}="true"]`).forEach(e=>{e instanceof HTMLElement&&(P(e),e.removeAttribute(V))})}function Xt(){if(u.userActivationEventsBound)return;let e=()=>{u.pageHasUserActivation=!0};window.addEventListener("pointerdown",e,{passive:!0,once:!0}),window.addEventListener("keydown",e,{passive:!0,once:!0}),window.addEventListener("click",e,{passive:!0,once:!0}),u.userActivationEventsBound=!0}function Ne(e){return!!(e&&e.tagName==="A"&&typeof e.getAttribute=="function"&&(e.getAttribute("href")||"").includes("#/configurationpage?name="))}function Hr(){let e=Array.from(document.querySelectorAll('a[href*="#/configurationpage?name="]')).filter(r=>Ne(r)&&(r.getAttribute("href")||"")!==ee),t=new Set;return e.forEach(r=>{let n=r.parentElement;if(!n)return;Array.from(n.children).filter(i=>Ne(i)).length>=2&&t.add(n)}),Array.from(t)}function Fr(){let e=window.location.hash||"";if(!e)return!1;try{let t=e.charAt(0)==="#"?e.slice(1):e,r=new URL(t,window.location.origin);return r.pathname==="/configurationpage"&&r.searchParams.get("name")===Qe}catch{return e.includes(ee)}}function Br(){let e=window.location.hash||"";return e==="#/dashboard/plugins"||e.indexOf("#/dashboard/plugins?")===0}function Vr(e,t){let r=Array.from(e.children).find(n=>!(n instanceof HTMLElement)||n===t?!1:n.classList.contains("Mui-selected"));return r?Array.from(r.classList).filter(n=>n==="Mui-selected"):[]}function Zt(e,t,r){e instanceof HTMLElement&&(t?(e.setAttribute("aria-current","page"),["Mui-selected"].concat(r||[]).forEach(n=>{e.classList.add(n)})):(e.removeAttribute("aria-current"),["Mui-selected"].forEach(n=>{e.classList.remove(n)})))}function Wr(e){Array.from(document.querySelectorAll('a[href="#/plugins"], a[href$="/#/plugins"], a[href="#/dashboard/plugins"], a[href$="/#/dashboard/plugins"]')).forEach(r=>{!(r instanceof HTMLElement)||r.getAttribute(te)==="true"||(e?(r.removeAttribute("aria-current"),["Mui-selected"].forEach(n=>{r.classList.remove(n)})):Br()&&(r.setAttribute("aria-current","page"),r.classList.add("Mui-selected")))})}function Qt(e){e.setAttribute(te,"true"),e.setAttribute("href",ee),e.setAttribute("title","Media Preview"),e.removeAttribute("id");let t=[".navMenuOptionText",".listItemBodyText",".drawerLinkText",".sectionTitleText",".button-text"],r=null;for(let n=0;n<t.length&&(r=e.querySelector(t[n]),!r);n+=1);if(!r){let n=e.querySelectorAll("span");r=n.length?n[n.length-1]:null}r?r.textContent="Media Preview":e.textContent="Media Preview"}function jr(){let e=Fr(),t=Hr();t.length&&t.forEach(r=>{let n=Vr(r,null);Wr(e);let o=Array.from(r.children).find(s=>Ne(s)&&(s.getAttribute("href")||"")===ee);if(o){Qt(o),Zt(o,e,n);return}let i=Array.from(r.children).find(s=>Ne(s));if(!i)return;let l=i.cloneNode(!0);Qt(l),Zt(l,e,n),r.appendChild(l)})}function G(){u.adminNavRefreshScheduled||(u.adminNavRefreshScheduled=!0,window.requestAnimationFrame(()=>{u.adminNavRefreshScheduled=!1,jr()}))}function ce(e){u.scanScheduled||(u.scanScheduled=!0,window.requestAnimationFrame(()=>{u.scanScheduled=!1,De(e||document)}))}function He(){u.observer||!document.body||(u.observer=new MutationObserver(e=>{e.forEach(t=>{t.addedNodes.forEach(r=>{r.nodeType===1&&(ce(r),G())})})}),u.observer.observe(document.body,{childList:!0,subtree:!0}))}function er(){if(u.routeEventsBound)return;let e=()=>{ce(document),G()};window.addEventListener("hashchange",e,{passive:!0}),window.addEventListener("popstate",e,{passive:!0}),document.addEventListener("viewshow",e,{passive:!0}),document.addEventListener("pageshow",e,{passive:!0}),u.routeEventsBound=!0,!u.historyPatched&&window.history&&typeof window.history.pushState=="function"&&(u.historyPatched=!0,["pushState","replaceState"].forEach(t=>{let r=window.history[t];window.history[t]=function(...o){let i=r.apply(this,o);return window.setTimeout(e,0),i}}))}function tr(){if(u.delegatedHoverEventsBound)return;let e=l=>{if(l.pointerType&&l.pointerType!=="mouse")return;let s=w(l.target);!s||w(l.relatedTarget)===s||Le(s,l)},t=l=>{if(l.pointerType&&l.pointerType!=="mouse")return;let s=w(l.target);s&&Oe(s,l)},r=l=>{if(l.pointerType&&l.pointerType!=="mouse")return;let s=w(l.target);!s||w(l.relatedTarget)===s||Ue(s,l)},n=l=>{let s=w(l.target);!s||w(l.relatedTarget)===s||pt(s,l)},o=l=>{let s=w(l.target);s&&mt(s,l)},i=l=>{let s=w(l.target);!s||w(l.relatedTarget)===s||ft(s)};document.addEventListener("pointerover",e,!0),document.addEventListener("pointermove",t,!0),document.addEventListener("pointerout",r,!0),document.addEventListener("mouseover",n,!0),document.addEventListener("mousemove",o,!0),document.addEventListener("mouseout",i,!0),u.delegatedHoverEventsBound=!0}function rr(e,t,r){return{config:a,start:e,destroy:t,rebind:r,debugHoldMs:fe,findCandidateCards:ye,getItemIdFromCard:T,getCardImageElement:nt,getTrickplayInfo:Y,getPreviewUrl:de,applyPreview:se,restoreCard:P,bindCard:ht,observePageChanges:He}}function nr(){u.expandedTrailerSession&&_({immediate:!0}),u.observer&&(u.observer.disconnect(),u.observer=null),Jt()}function Fe(){if(wt(),!a.enabled){Ee("Media Preview is disabled by config.");return}if(window.matchMedia&&!window.matchMedia("(hover: hover) and (pointer: fine)").matches){Ee("Skipping media preview because the current device does not advertise precise hover.");return}Yt(),Xt(),er(),tr(),De(document),G(),He(),Ee("Media Preview initialized.")}function or(){ce(document)}var ir=rr(Fe,nr,or);window[bt]=ir;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Fe,{once:!0}):Fe();var $r=ir;return cr(Kr);})();
